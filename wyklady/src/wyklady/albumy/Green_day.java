...
public class Green_day {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Green_day window = new Green_day();
	...
	private void initialize() {
		...
		try {
			...
			Statement stmt=con.createStatement();
			int i=0;
			String sql2="Select Tytul,Wykonawca,Album,Data_publikacji,id from utwory where Wykonawca='Green day' or Wykonawca='green day'";
