...
public class inne {
	...
	private void initialize() {
		...
		try {
			...
			Statement stmt=con.createStatement();
			int i=0;
			String sql2="Select Tytul,Wykonawca,Album,Data_publikacji,id from utwory where not Wykonawca='Metallica' and not Wykonawca='Nirvana' and not Wykonawca='Green day' and not Wykonawca='Daft punk' and not Wykonawca='Beatles'";
