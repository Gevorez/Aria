...
public class metallica {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					metallica window = new metallica();
	...
	private void initialize() {
		...
		try {
			...
			Statement stmt=con.createStatement();
			int i=0;
			String sql2="Select Tytul,Wykonawca,Album,Data_publikacji,id from utwory where Wykonawca='Metallica' or Wykonawca='metallica'";
